...
<template>
  <main id="content">
    <div id="Introdução">
      ...
      />
      <h1>Atenção!!!</h1>
      <h3>Esse site está entupido de spoilers, se você não assistiu e gostaria de ter uma experiência sem spoilers eu recomendo que você saia deste site AGORA! (A não ser que você não se importe com spoilers, embora eu recomende que você tenha a experiência completa)</h3>
      <h3>Esse site foi produzido como um trabalho escolar para o segundo ano do ensino médio (vou colocar a nota aqui dps que entregar kk) mas também como uma forma de compartilhar os aspectos que eu mais gosto desse desenho com as pessoas que quiserem acessá-lo, então prepare-se pois vamos entrar em uma aventura e tanto!!!11!!1!!!</h3>
      </div>
    <div id="Resumo">
      ...
      <h3>Apesar do foco em comédia, o desenho possui uma tonelada de segredos e detalhes ao longo que tornam a lore do mesmo muito mais complexa, desde de um sistema político corrupto até profecias e horrores desumanos além de nossa compreensão.
      </h3>
      <h2>
